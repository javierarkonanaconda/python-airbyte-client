...
class JobsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_job_debug_info_endpoint = _Endpoint(
            settings={
                'response_type': (JobDebugInfoRead,),
                'auth': [],
                'endpoint_path': '/v1/jobs/get_debug_info',
                'operation_id': 'get_job_debug_info',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_job_debug_info(
        ...
        **kwargs
        ...
        >>> thread = api.get_job_debug_info(job_id_request_body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['job_id_request_body'] = \
            job_id_request_body
        return self.get_job_debug_info_endpoint.call_with_http_info(**kwargs)
