...
class WebBackendApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.web_backend_get_workspace_state_endpoint = _Endpoint(
            settings={
                'response_type': (WebBackendWorkspaceStateResult,),
                'auth': [],
                'endpoint_path': '/v1/web_backend/workspace/state',
                'operation_id': 'web_backend_get_workspace_state',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'web_backend_workspace_state': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def web_backend_get_workspace_state(
        ...
        **kwargs
        ...
        >>> thread = api.web_backend_get_workspace_state(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            web_backend_workspace_state (WebBackendWorkspaceState): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.web_backend_get_workspace_state_endpoint.call_with_http_info(**kwargs)
