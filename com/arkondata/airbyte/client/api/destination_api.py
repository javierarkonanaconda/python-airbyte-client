...
class DestinationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.clone_destination_endpoint = _Endpoint(
            settings={
                'response_type': (DestinationRead,),
                'auth': [],
                'endpoint_path': '/v1/destinations/clone',
                'operation_id': 'clone_destination',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def clone_destination(
        ...
        **kwargs
        ...
        >>> thread = api.clone_destination(destination_id_request_body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['destination_id_request_body'] = \
            destination_id_request_body
        return self.clone_destination_endpoint.call_with_http_info(**kwargs)
