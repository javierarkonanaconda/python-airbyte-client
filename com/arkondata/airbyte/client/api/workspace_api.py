...
class WorkspaceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.update_workspace_name_endpoint = _Endpoint(
            settings={
                'response_type': (WorkspaceRead,),
                'auth': [],
                'endpoint_path': '/v1/workspaces/update_name',
                'operation_id': 'update_workspace_name',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def update_workspace_name(
        ...
        **kwargs
        ...
        >>> thread = api.update_workspace_name(workspace_update_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['workspace_update_name'] = \
            workspace_update_name
        return self.update_workspace_name_endpoint.call_with_http_info(**kwargs)
