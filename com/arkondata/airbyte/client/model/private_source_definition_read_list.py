...
def lazy_import():
    ...
    globals()['PrivateSourceDefinitionRead'] = PrivateSourceDefinitionRead


class PrivateSourceDefinitionReadList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'source_definitions': ([PrivateSourceDefinitionRead],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, source_definitions, *args, **kwargs):  # noqa: E501
        ...
        Args:
            source_definitions ([PrivateSourceDefinitionRead]):
