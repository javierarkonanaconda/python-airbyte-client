...
class WorkspaceUpdateName(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, workspace_id, name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, workspace_id, name, *args, **kwargs):  # noqa: E501
        """WorkspaceUpdateName - a model defined in OpenAPI
